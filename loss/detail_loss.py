...
if __name__ == '__main__':
    ...
    img_path = 'E:/data/cityscapes/gtFine/val/frankfurt/frankfurt_000001_037705_gtFine_labelIds.png'
    ...
    # print('img_tensor:', type(img_tensor), img_tensor.size())
    ...
    # print('bce:', type(bce_loss))
    # print('dice:', type(dice_loss))
