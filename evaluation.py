...
# from models.Ablation.MARSNet import BiSeNet
...
class MscEvalV0(object):
    ...
    def __call__(self, net, dl, n_classes):
        ...
        #     print(i)
        #     time_sum += i
        # time_sum = time_sum - data_time[0]
            # if step >= 300:
            #     print(i)
            #     time_sum += i

        # print('test finish!!!')
        # print("FPS为: %f" % (1.0 / (time_sum / (len(data_time)-1))))
        return miou.item()


def evaluatev0(respth='./pretrained', dspth='E:/data/cityscapes', backbone='CatNetSmall',
               scale=0.75, use_boundary_2=False, use_boundary_4=False, use_boundary_8=False,
    ...
    batchsize = 5
    n_workers = 2
    valset = CityScapes(dspth, mode='val')
    # dataloader
    ...
    with torch.no_grad():
        ...
        mIOU = single_scale(net, valLoader, 19)
    logger = logging.getLogger()  # 日志对象初始化
...
if __name__ == "__main__":
    ...
    # evaluatev0('E:/data/Pretrained_model/STDC/STDC2-Seg/model_maxmIOU75.pth', dspth='E:/data/cityscapes', backbone='STDCNet1446', scale=0.75,
    # use_boundary_2=False, use_boundary_4=False, use_boundary_8=True, use_boundary_16=False)

    evaluatev0('D:/STDC-Seg-master/checkpoints/Ablation/MARNet/model_iter4000_maxmIOU75_0.7623.pth',
